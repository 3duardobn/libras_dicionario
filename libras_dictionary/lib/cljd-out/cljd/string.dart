...
final dc.bool or$6718_$AUTO_$1=(null == (s$1 as dc.String?));
if(or$6718_$AUTO_$1){
...
final dc.String coll7048$1=(s$1 as dc.String);
...
final dc.String coll7028$1=(s$1 as dc.String);
void f7029$1(dc.dynamic p1$8988_$SHARP_$1, dc.dynamic p2$8987_$SHARP_$1, ){
late final dc.dynamic temp$6859_$AUTO_$1;
if((cmap$1 is dc.Function)){
temp$6859_$AUTO_$1=(cmap$1 as dc.Function)(p2$8987_$SHARP_$1, );
}else if((cmap$1 is lcoc_core.IFn$iface)){
temp$6859_$AUTO_$1=((cmap$1 as lcoc_core.IFn$iface).$_invoke$1(p2$8987_$SHARP_$1, ));
}else{
temp$6859_$AUTO_$1=(lcoc_core.IFn.extensions(cmap$1, ).$_invoke$1(cmap$1, p2$8987_$SHARP_$1, ));
}
late final dc.dynamic $if_$1;
if(((false != temp$6859_$AUTO_$1) && (null != temp$6859_$AUTO_$1))){
$if_$1=(lcoc_core.str.$_invoke$1(temp$6859_$AUTO_$1, ));
}else{
$if_$1=p2$8987_$SHARP_$1;
}
return (sb$1.write($if_$1, ));
}
if((coll7028$1 is lcoc_core.IReduce$iface)){
((coll7028$1 as lcoc_core.IReduce$iface).$_reduce$2(f7029$1, null, ));
}else{
((lcoc_core.IReduce.extensions(coll7028$1, ) as lcoc_core.IReduce$ext).$_reduce$2(coll7028$1, f7029$1, null, ));
}
...
// BEGIN ifn_index_of_M__18695hm$1
class ifn_index_of_M__18695hm$1 extends dc.Object with lcoc_core.IFnMixin_uuXX implements lcoc_core.IMeta$iface, lcoc_core.IWithMeta$iface, lcoc_core.Fn$iface, lcoc_core.IFn$iface {
final meta$1;

ifn_index_of_M__18695hm$1(this.meta$1, ):super();
...
return lcoc_string.ifn_index_of_M__18695hm$1(m$2647_$AUTO_$1, );
}
...
// END ifn_index_of_M__18695hm$1

// BEGIN ifn_join_M__18695hm$1
class ifn_join_M__18695hm$1 extends dc.Object with lcoc_core.IFnMixin_uXX implements lcoc_core.IMeta$iface, lcoc_core.IWithMeta$iface, lcoc_core.Fn$iface, lcoc_core.IFn$iface {
final meta$1;

ifn_join_M__18695hm$1(this.meta$1, ):super();
...
dc.dynamic $_with_meta$1(dc.dynamic m$2647_$AUTO_$1, ){
return lcoc_string.ifn_join_M__18695hm$1(m$2647_$AUTO_$1, );
}
...
// END ifn_join_M__18695hm$1

// BEGIN ifn_last_index_of_M__18695hm$1
class ifn_last_index_of_M__18695hm$1 extends dc.Object with lcoc_core.IFnMixin_uuXX implements lcoc_core.IMeta$iface, lcoc_core.IWithMeta$iface, lcoc_core.Fn$iface, lcoc_core.IFn$iface {
final meta$1;

ifn_last_index_of_M__18695hm$1(this.meta$1, ):super();
...
dc.dynamic $_with_meta$1(dc.dynamic m$2647_$AUTO_$1, ){
return lcoc_string.ifn_last_index_of_M__18695hm$1(m$2647_$AUTO_$1, );
}
...
// END ifn_last_index_of_M__18695hm$1

// BEGIN ifn_split_M__18695hm$1
class ifn_split_M__18695hm$1 extends dc.Object with lcoc_core.IFnMixin_uuXX implements lcoc_core.IMeta$iface, lcoc_core.IWithMeta$iface, lcoc_core.Fn$iface, lcoc_core.IFn$iface {
final meta$1;

ifn_split_M__18695hm$1(this.meta$1, ):super();
...
dc.dynamic $_with_meta$1(dc.dynamic m$2647_$AUTO_$1, ){
return lcoc_string.ifn_split_M__18695hm$1(m$2647_$AUTO_$1, );
}
...
dc.dynamic i$1=0;
final dc.dynamic o6974$1=(lcoc_core.take.$_invoke$2(((limit$1 as dc.num) - 1), (re$3.allMatches(s$4, )), ));
dc.dynamic matches$1;
if((o6974$1 is lcoc_core.ISeqable$iface)){
matches$1=((o6974$1 as lcoc_core.ISeqable$iface).$_seq$0());
}else{
matches$1=((lcoc_core.ISeqable.extensions(o6974$1, ) as lcoc_core.ISeqable$ext).$_seq$0(o6974$1, ));
}
do {
final dc.dynamic some$6849_$AUTO_$1=matches$1;
...
final dc.dynamic vec$8984_$1=some$6849_$AUTO_$1;
final dc.dynamic o6974$2=vec$8984_$1;
late final dc.dynamic seq$8985_$1;
if((o6974$2 is lcoc_core.ISeqable$iface)){
seq$8985_$1=((o6974$2 as lcoc_core.ISeqable$iface).$_seq$0());
}else{
seq$8985_$1=((lcoc_core.ISeqable.extensions(o6974$2, ) as lcoc_core.ISeqable$ext).$_seq$0(o6974$2, ));
}
final dc.dynamic first$8986_$1=lcoc_core.first(seq$8985_$1, );
final dc.dynamic seq$8985_$2=lcoc_core.next(seq$8985_$1, );
final dc.Match m$1=(first$8986_$1 as dc.Match);
v$1=(lcoc_core.conj$BANG_.$_invoke$2(v$1, (lcoc_core.subs.$_invoke$3(s$4, i$1, m$1.start, )), ));
i$1=m$1.end;
matches$1=seq$8985_$2;
continue;
} while(true);
}
...
// BEGIN index-of
lcoc_core.IFn$iface index_of=lcoc_string.ifn_index_of_M__18695hm$1(null, );

// END index-of

// BEGIN join
lcoc_core.IFn$iface join=lcoc_string.ifn_join_M__18695hm$1(null, );

// END join

// BEGIN last-index-of
lcoc_core.IFn$iface last_index_of=lcoc_string.ifn_last_index_of_M__18695hm$1(null, );
...
if((replacement$2 is dc.String Function(dc.Match, ))){
wrapper_f$1=replacement$2;
}else{
wrapper_f$1=(dc.dynamic $1, ){
if((replacement$2 is dc.Function)){
return (replacement$2 as dc.Function)($1, );
}
if((replacement$2 is lcoc_core.IFn$iface)){
return ((replacement$2 as lcoc_core.IFn$iface).$_invoke$1($1, ));
}
return (lcoc_core.IFn.extensions(replacement$2, ).$_invoke$1(replacement$2, $1, ));
};
}
...
dc.dynamic i$1=0;
do {
final dc.Match? some$6849_$AUTO_$1=(re$1.matchAsPrefix((replacement$1 as dc.String), (i$1 as dc.int), ));
if((null == some$6849_$AUTO_$1)){
final dc.dynamic coll7048$1=vs$1;
late final dc.int cast$1;
if((coll7048$1 is lcoc_core.ICounted$iface)){
cast$1=(((coll7048$1 as lcoc_core.ICounted$iface).$_count$0()) as dc.int);
}else{
...
final dc.bool and$6836_$AUTO_$1=(lcoc_core.$EQ_.$_invoke$2(1, cast$1, ));
...
final dc.StringBuffer sb$1=dc.StringBuffer();
void f7029$1(dc.dynamic p1$8979_$SHARP_$1, dc.dynamic p2$8978_$SHARP_$1, ){
late final dc.dynamic $if_$2;
if((p2$8978_$SHARP_$1 is dc.String)){
$if_$2=p2$8978_$SHARP_$1;
}else{
$if_$2=((m$1 as dc.Match).group((p2$8978_$SHARP_$1 as dc.int), ));
}
return (sb$1.write($if_$2, ));
}
if((vs$2 is lcoc_core.IReduce$iface)){
((vs$2 as lcoc_core.IReduce$iface).$_reduce$2(f7029$1, null, ));
}else{
((lcoc_core.IReduce.extensions(vs$2, ) as lcoc_core.IReduce$ext).$_reduce$2(vs$2, f7029$1, null, ));
}
return (sb$1.toString());
};
}
final dc.dynamic coll7013$1=vs$1;
final dc.String? some$6849_$AUTO_$2=((some$6849_$AUTO_$1 as dc.Match).group(1, ));
late final dc.Comparable<dc.Comparable<dc.Object>> o7014$1;
if((null == some$6849_$AUTO_$2)){
o7014$1=(dc.int.parse((((some$6849_$AUTO_$1 as dc.Match).group(2, )) as dc.String), ));
}else{
o7014$1=lcoc_string.re_unquote_replacement(some$6849_$AUTO_$2, );
}
if((coll7013$1 is lcoc_core.ICollection$iface)){
vs$1=((coll7013$1 as lcoc_core.ICollection$iface).$_conj$1(o7014$1, ));
}else{
vs$1=((lcoc_core.ICollection.extensions(coll7013$1, ) as lcoc_core.ICollection$ext).$_conj$1(coll7013$1, o7014$1, ));
}
i$1=(some$6849_$AUTO_$1 as dc.Match).end;
continue;
} while(true);
}
...
// BEGIN split
lcoc_core.IFn$iface split=lcoc_string.ifn_split_M__18695hm$1(null, );
...
dc.int index$1=(s$1 as dc.String).length;
do {
if((0 == index$1)){
return "";
}
final dc.String ch$1=((s$1 as dc.String)[(index$1 - 1)]);
final dc.bool or$6718_$AUTO_$1=(lcoc_core.$EQ_.$_invoke$2(ch$1, "\n", ));
late final dc.bool $if_$1;
if(or$6718_$AUTO_$1){
...
return ((s$1 as dc.String).substring(0, index$1, ));
} while(true);
}
