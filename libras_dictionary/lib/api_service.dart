  ...
  Future<List<DictItem>> _fetchSpreadTheSign(String query) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (videoMatch != null) {
        ...
        final RegExp titleExp = RegExp(r'<span class="flag-icon flag-icon-br bordered"><\/span>\s*([^<\n]+)');
      ...
      final RegExp resultExp = RegExp(r'<div class="search-result-title">\s*<a href="(\/pt\.br\/word\/[^"]+)"[^>]*>\s*([^<\n]+)');
